      ...
      <div class="row g-3">
        ...
        <div class="col-md-7 col-lg-8">
         ...
         <div class="card-body">
          ...
          <form class="needs-validation" novalidate="" onSubmit={(e)=>{e.preventDefault();addAddress(address);}}>
            <div class="row g-3">
              <div class="col-sm-6">
                <label for="firstName" class="form-label">First name</label>
                <input type="text" class="form-control" id="firstName" placeholder="" value={address.first_name} onChange={e=>address.first_name=e.target.value}/>
              ...
              <div class="col-sm-6">
                ...
                <input type="text" class="form-control" id="lastName" placeholder=""  value={address.last_name} onChange={e=>address.last_name=e.target.value}/>
                <div class="invalid-feedback">
              ...
              <div class="col-12">
                ...
                <input type="tel" class="form-control" id="phone" placeholder="+91-1111111111" value={address.phone} onChange={e=>address.phone=e.target.value}/>
                <div class="invalid-feedback">
              ...
              <div class="col-12">
                ...
                <input type="text" class="form-control" id="address" placeholder="1234 Main St" value={address.address1} onChange={e=>address.address1=e.target.value}/>
                <div class="invalid-feedback">
              ...
              <div class="col-12">
                ...
                <input type="text" class="form-control" id="address2" placeholder="Apartment or suite" value={address.address2} onChange={e=>address.address2=e.target.value}/>
              </div>
  
              <div class="col-md-5">
                <label for="country" class="form-label">Country</label>
                <select class="form-select" id="country" value={address.country} onChange={e=>address.country=e.target.value}>
              ...
              <div class="col-md-4">
                ...
                <select class="form-select" id="state"  value={address.state} onChange={e=>address.state=e.target.value} >
                  <option value="">Choose...</option>
                  <option>Delhi</option>
                  <option>UP</option>
              ...
              <div class="col-md-3">
                ...
                <input type="text" class="form-control" id="zip" placeholder="" value={address.pin_code} onChange={e=>address.pin_code=e.target.value} />
                <div class="invalid-feedback">
                  Zip code required.
                </div>
              </div>
