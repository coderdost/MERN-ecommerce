import { CHANGED_ITEM_IN_CART, CHANGE_ORDER_CART, CHANGED_QUANTITY,ADD_ADDRESS, SET_SHIP_ADDRESS,PLACE_ORDER,EMPTY_CART,REMOVE_ITEM, INIT_PRODUCTS, INIT_CART, INIT_USER } from '../actions';
